...
public class CidadesBusiness {
   ...
   * @generated
   */
  public Page<Cidades> findCidadessByUser(java.lang.String instanceId, Pageable pageable) {
    // begin-user-code
    // end-user-code  
    Page<Cidades> result = repository.findCidadessByUser(instanceId, pageable);
    // begin-user-code  
    // end-user-code        
    return result;
  }
